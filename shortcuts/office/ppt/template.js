let shortcutTemplate = [
    ...
    {
        "title": "新建演示文稿 {cmd_or_ctrl} + N",
        "description": "新建一个演示文稿",
        "keyword": "new presentation xin jian yi ge yan shi wen gao",
        "keys": ["n", "{cmd_or_ctrl}"]
    },
    {
    ...
    {
        "title": "隐藏PowerPoint {cmd_or_ctrl} + H",
        "description": "隐藏PowerPoint应用程序",
        "keyword": "hide PowerPoint yin cang PowerPoint",
        "keys": ["h", "{cmd_or_ctrl}"]
    },
    {
