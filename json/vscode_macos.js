let shortcuts = [
    {
        ...
        description: '格式化代码',
        keyword: '格式化 format vscode visual studio',
        keys: ['f', 'shift', 'option'],
    ...
    },
    {
        ...
        keyword: '格式化 format 行 capture vscode',
    ...
    },
    {
        ...
        keyword: '光标 跳转 文件 上一个 最近 vscode',
        keys: ['-', 'ctrl'],
        icon: 'icons/vscode.png'
    },
    {
    ...
    },
    {
        title: '界面缩小 cmd + -',
        description: '界面缩小',
        keyword: 'zoom out suoxiao vscode',
        keys: ['-', 'command'],
        icon: 'icons/vscode.png'
    },
    {
        ...
        description: '全部保存',
        keyword: 'quanbu baocun save all vscode',
    ...
    },
    {
        title: '自动换行 option + z',
        description: '自动换行',
        keyword: 'hh huanhang line wrapper vscode',
        keys: ['z', 'option'],
        icon: 'icons/vscode.png'
    },
    {
        ...
        keyword: 'kuaijiejian shortcuts hotkeys kjj vscode',
    ...
    },
    {
        ...
        keyword: 'kuaijiejian shortcuts hotkeys kjj chuangkou ck window vscode',
    ...
    },
    {
        ...
        description: '在VSCode窗口显示和设置快捷键',
        keyword: 'reset shortcuts hotkeys kjj chuangkou ck window vscode',
    ...
    },
    {
        title: '前进 ctrl + -',
        description: '后退',
        keyword: 'forward vscode qianjin',
        keys: ['-', 'ctrl', 'shift'],
        icon: 'icons/vscode.png'
    }
]
