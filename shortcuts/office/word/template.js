let shortcutTemplate = [
    ...
    {
        "title": "粘贴并匹配格式 {cmd_or_ctrl} + Shift + V",
        "description": "粘贴内容并匹配格式",
        "keyword": "paste and match format zhan tie nei rong bing pi pei ge shi",
        "keys": ["v", "{cmd_or_ctrl}", "shift"]
    },
    {
    ...
    {
        "title": "新建文档 {cmd_or_ctrl} + N",
        "description": "新建一个文档",
        "keyword": "new document xin jian yi ge wen dang",
        "keys": ["n", "{cmd_or_ctrl}"]
    },
    {
        "title": "打开... {cmd_or_ctrl} + O",
        "description": "打开文件或对话框等",
        "keyword": "open da kai",
        "keys": ["o", "{cmd_or_ctrl}"]
    },
    {
    ...
    {
        "title": "隐藏Word {cmd_or_ctrl} + H",
        "description": "隐藏Word应用程序",
        "keyword": "hide Word yin cang Word",
        "keys": ["h", "{cmd_or_ctrl}"]
    },
    {
